...
import robot_nira.assembly_femur as assembly_femur
import robot_nira.assembly_tibia as assembly_tibia
...
def main() -> None:
    ...
    export_step(assembly, str(EXPORT_DIR / "step/assembly_leg.step"))
